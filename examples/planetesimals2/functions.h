...
void check_for_encounter(struct reb_simulation* r, struct reb_simulation* s, int* N_encounters, int N_encounters_previous, double* minimum_r, double* maximum_val, char* xyz_check, double* dKE, double soft, double ejection_distance2);
