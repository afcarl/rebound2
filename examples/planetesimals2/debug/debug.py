...
file_name1 = 'HYB_sept14_par13_single.txt'
file_name2 = 'HYB_sept14_par13_group.txt'
...
for i in xrange(0,1):
    p=data[i::N_active]
    q=data2[i::N_active]
    plt.plot(p[arg4:arg3,arg1], p[arg4:arg3,arg2] - q[arg4:arg3,arg2], 'o'+colors[i], marker='o', markersize=5-i,markeredgecolor='none',label=bodynames[i] )
