...
int n_output, CE_index = 0, encounter_index = 0, previous_encounter_index = 0, dt_counter=1;
...
int main(int argc, char* argv[]){
    ...
    //double a2=0.664171, m2=3e-6, e2=0;
    struct reb_particle p2 = reb_tools_init_orbit2d(r->G,star.m,m2,a2,e2,0,0.948809);
    reb_add(r, p2);
    r->N_active++;
